...
@example
	...
	var xbau_uploader = $('#xbau_uploader').pluploadQueue();

	xbau_uploader.bind('FilesAdded', function() {

		// Autostart
		setTimeout(xbau_uploader.start, 1); // "detach" from the main thread
	});
...
;(function($, plupload) {
	...
	$.fn.pluploadQueue = function(settings) {
		if (settings) {
			...
			// Get xbau_uploader instance for specified element
