...
var plupload = {
	...
	*/
	 ...
	 * and a file to be filtered. Callback is executed in the context of xbau_uploader instance.
	 *
...
@param {Object} settings For detailed information about each option check documentation.
	...
	@param {String|DOMElement} [settings.container] id of the DOM element or DOM element itself that will be used to wrap xbau_uploader structures. Defaults to immediate parent of the `browse_button` element.
...
plupload.Uploader = function(options) {
	...
	/**
	Fires when the option is changed in via xbau_uploader.setOption().

	@event OptionChanged
	@since 2.1
	@param {plupload.Uploader} xbau_uploader Uploader instance sending the event.
	...
	/**
	Fires when the file queue is changed. In other words when files are added/removed to the files array of the xbau_uploader instance.
	...
	* on the xbau_uploader instance before the chunk is uploaded.
	*
	...
	*/
	...
	plupload.extend(this, {
		...
		/**
		 * Map of features that are available for the xbau_uploader runtime. Features will be filled
		...
		*/
		...
		/**
		Check whether xbau_uploader has any listeners to the specified event.
