...
@example
	<!-- Instantiating: -->
	<div id="xbau_uploader">
		<p>Your browser doesn't have Flash, Silverlight or HTML5 support.</p>
	</div>

	<script>
		$('#xbau_uploader').plupload({
			url : '../upload.php',
			filters : [
...
@example
	// Invoking methods:
	$('#xbau_uploader').plupload(options);

	// Display welcome message in the notification area
	$('#xbau_uploader').plupload('notify', 'info', "This might be obvious, but you need to click 'Add Files' to add some files.");
...
@example
	...
	$('#xbau_uploader').on("viewchanged", function(event, args) {
		// stuff ...
	});
...
$.widget("ui.plupload", {
	...
	_create: function() {
		...
		// initialize xbau_uploader instance
		this._initUploader();
	},
	...
	_initUploader: function() {
		...
		// xbau_uploader internal events must run first
		uploader.init();
	...
	*/
	...
	/**
	Destroy the widget, the xbau_uploader, free associated resources and bring back original html.

	@method destroy
	*/
	destroy: function() {
		// destroy xbau_uploader instance
